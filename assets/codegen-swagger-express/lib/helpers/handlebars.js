...
const mockHandler = require('../../../mock-module/mock.handler');
/**
 * Compares two values.
 */
...
Handlebars.registerHelper('generateResponse', (responses, spec, dynamic) => {
  return mockHandler.generateResponse(responses, spec, dynamic);
});
